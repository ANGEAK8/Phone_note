...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.add_img = tk.PhotoImage(file='./itog/img/add.png')
        ...
        self.update_img = tk.PhotoImage(file='./itog/img/update.png')
...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        label_sum = tk.Label(self, text='Заработная плата')
        label_sum.place(x=50, y=120)
        ...
        self.entry_sal.place(x=200, y=120)
